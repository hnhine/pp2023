...
class Course(Entity):
    def __init__(self, course_id, name, etc):
...
class ListCourse():
    ...
    def insert(self, s: Course):
        ...
        return 1
    def display (self):
        print("course_id             name     etc\n")
        for i in self.__list:
            print(f"{i.getID():22}{i.getName():10}{i.getETC():5}\n")

class Mark:
    def __init__(self, course_id, student_id, mark):
        self.__course_id = course_id
        self.__student_id = student_id
        self.__mark = round_one_dec(mark)
    def getMark(self):
        return self.__mark
    ...
    def add_course(self):
        for i in range(self.__total_course):
            while True:
                ...
                c_etc = input(f"Enter course etc {i+1} :\n")
                c = Course(c_id, c_name, c_etc)
